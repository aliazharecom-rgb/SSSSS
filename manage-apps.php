...
public static api KeyAuthApp = new api(
    ...
    version: "<?= $version; ?>"
                            ...
                            <a href="https://github.com/KeyAuth/UMAR AUTH-CSHARP-Example" target="_blank" type="button"
                                ...
                                View
                                C# Example</a>
                            <a href="https://github.com/KeyAuth/UMAR AUTH-Unity-Example" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
...
std::string url = skCrypt("https://keyauth.win/api/1.2/").decrypt(); // change if you're self-hosting</pre>
                            ...
                            <button type="button"
                                ...
                                Copy Credentials</button>
                            <a href="https://github.com/KeyAuth/UMAR AUTH-CPP-Example" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
...
KeyAuthApp = api(
    ...
    hash_to_check = getchecksum()
                            ...
                            <button type="button"
                                ...
                                Copy Credentials</button>
                            <a href="https://github.com/KeyAuth/UMAR AUTH-Python-Example" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
...
$ownerid = "<?= $ownerid; ?>";</pre>
                            ...
                            <button type="button"
                                ...
                                Copy Credentials</button>
                            <a href="https://github.com/KeyAuth/UMAR AUTH-PHP-Example" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
...
const KeyAuthApp = new KeyAuth(
    ...
    "<?= $version; ?>",
                            ...
                            <button type="button"
                                ...
                                Copy Credentials</button>
                            <a href="https://github.com/mazkdevf/UMAR AUTH-JS-Example" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
...
private static String version = "<?= $version; ?>"</pre>
                            ...
                            <button type="button"
                                ...
                                Copy Credentials</button>
                            <a href="https://github.com/KeyAuth-Archive/UMAR AUTH-JAVA-api" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
...
Private Shared version As String = "<?= $version; ?>"</pre>
                            ...
                            <button type="button"
                                ...
                                Copy Credentials</button>
                            <a href="https://github.com/KeyAuth/UMAR AUTH-VB-Example" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
...
let mut KeyAuthApp = KeyAuth::v1_2::KeyAuthApi::new(
    ...
    "https://keyauth.win/api/1.2/", // This is the API URL, change this to your custom domain if you have it enabled
                            ...
                            <button type="button"
                                ...
                                Copy Credentials</button>
                            <a href="https://github.com/KeyAuth/UMAR AUTH-Rust-Example" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
...
var version = "<?= $version; ?>"</pre>
                            ...
                            <button type="button"
                                ...
                                Copy Credentials</button>
                            <a href="https://github.com/mazkdevf/UMAR AUTH-Go-Example" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
...
local version = "<?= $version; ?>";</pre>
                            ...
                            <button type="button"
                                ...
                                Copy Credentials</button>
                            <a href="https://github.com/mazkdevf/UMAR AUTH-Lua-Examples" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
...
KeyAuth.new.Api(
    ...
    "<?= $version; ?>"
                            ...
                            <button type="button"
                                ...
                                Copy Credentials</button>
                            <a href="https://github.com/mazkdevf/UMAR AUTH-Ruby-Example" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
...
KeyAuth::Api(
    ...
    "<?= $version; ?>"
                            ...
                            <button type="button"
                                ...
                                Copy Credentials</button>
                            <a href="https://github.com/mazkdevf/UMAR AUTH-Perl-Example" target="_blank" type="button"
                                class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200">
